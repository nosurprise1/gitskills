...
df=df[['日期','1个月存单利率','3个月存单利率','6个月存单利率','1年存单利率','1个月存单收益率曲线','3个月存单收益率曲线','6个月存单收益率曲线','1年存单收益率曲线','足年国股','收票','出票']]
df=df[df['日期']>='2018-01-08']
print(df)
stop
...
sns.pairplot(df, x_vars=['6个月存单利率变动','收票/出票'], y_vars='足年国股利率变动',kind="reg", size=5, aspect=0.7)
